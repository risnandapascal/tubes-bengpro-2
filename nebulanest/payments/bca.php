...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Informasi rekening tujuan BCA
    $account_number = '1234567890'; 
    $account_name = 'Johanes Raditya';
...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        ...
        <!-- BCA Payment Form Section -->
        <section class="bg-light py-5" id="bca-payment">
            <div class="container px=5 my-5">
                <div class="text-center mb-5">
                    <img src="assets/bca.png" alt="BCA Payment" class="img-fluid fw-bolder text-primary mb-3" style="max-width: 200px;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="paymentModalLabel">Instruksi Pembayaran BCA</h5>
