...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Informasi rekening tujuan Bank Mandiri
    $account_number = '9876543210'; 
    $account_name = 'Fasya Lavina Attasya';
...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        ...
        <!-- Bank Mandiri Payment Form Section -->
        <section class="bg-light py-5" id="mandiri-payment">
            <div class="container px=5 my-5">
                <div class="text-center mb-5">
                    <img src="assets/mandiri.png" alt="Bank Mandiri Payment" class="img-fluid fw-bolder text-primary mb-3" style="max-width: 200px;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="paymentModalLabel">Instruksi Pembayaran Bank Mandiri</h5>
